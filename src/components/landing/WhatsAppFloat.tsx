...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-4 right-4 z-[90] flex flex-col items-end gap-2 sm:bottom-6 sm:right-6"
    >
      ...
      <span className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 transition-transform hover:scale-105 hover:bg-[#20bd5a] active:scale-95">
